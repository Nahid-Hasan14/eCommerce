                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="breadcrumbs-inner">
                                <h1 class="breadcrumbs-title">Change customer password</h1>
                                <ul class="breadcrumb-list">
                                    <li><a href="{{route('index')}}">Home</a></li>
                                    <li style="color: #FF7F00">Change Password</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="{{route('customer.change.password')}}" method="POST">
                                    ...
                                    <div class="login-account p-30 box-shadow">
                                        ...
                                        <div style="display:flex; justify-content:space-between; margin-top:20px;">
                                            <button class="submit-btn-1 btn-hover-1" type="submit">Change</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
