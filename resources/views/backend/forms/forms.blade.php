                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="last-name" required class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="birthday" class="date-picker form-control" required type="text">
                        </div>
                      </div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-label-left input_mask">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                          <input class="date-picker form-control" required type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group row">
              ...
              <div class="x_content">
                ...
                <form class="form-horizontal form-label-left">
                  <div class="form-group row">
                    ...
                    <div class="col-md-7">
                      <input type="text" id="first-name2" required class="form-control col-md-7 ">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-md-7">
                      <input type="text" id="last-name2" name="last-name" required class="form-control col-md-7 ">
                    </div>
                  </div>
                </form>
